...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 66.0, 66.5, 117.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 38.0, 66.5, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					"data" : 					{
						"http_method" : "get",
						"url" : "https://data.brla.gov/resource/g5c2-myyj.json",
						"response_dict" : "recentChecks",
						"parse_type" : "json"
					}
,
					"id" : "obj-8",
					...
					"numoutlets" : 4,
					"outlettype" : [ "dictionary", "", "", "" ],
					"patching_rect" : [ 38.0, 104.5, 91.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "dictionary", "" ],
					"patching_rect" : [ 38.0, 142.5, 47.0, 22.0 ],
					"style" : "",
					"text" : "maxurl"
				}
